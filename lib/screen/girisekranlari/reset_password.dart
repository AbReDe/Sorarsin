...
class _Create_PasswordState extends State<Create_Password> {
  ...
  final TextEditingController _aceptpasswordContrller = TextEditingController();
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 6),
                      child: TextFormField(
                        controller: _aceptpasswordContrller,
                        obscureText: true,
                        style: TextStyle(color: Textcolor),
                        decoration: InputDecoration(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          // Checkbox ve yazı arasında biraz boşluk bırakır
                          const Text(
                    ...
                    Padding(
                      ...
                      child: MaterialButton(
                        onPressed:
                            _onaylandiMi
                                ? () {
                                  _userFunctions.Reset_password(
                                    context,
                                    _emailControler.text,
                                    _newpasswordController.text,
                                    _aceptpasswordContrller.text,
                                  );
                                }
                                : null,
